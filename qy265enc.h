...
const char* const  qy265_preset_names[] = { "superfast", "veryfast", "fast", "medium", "slow", "veryslow", "placebo", 0 };
const char* const  qy265_tunes_names[] = { "default", "selfshow", "game", "movie", "screen", 0 };
const char* const  qy265_latency_names[] = { "zerolatency", "lowdelay", "livestreaming", "offline", 0 };
