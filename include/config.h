...
#define FFMPEG_CONFIGURATION "--enable-gpl --enable-nonfree --yasmexe=/Users/jkchen/Documents/svn/v2.0-b4/trunk/objs/ffmpeg.src/_release/bin/yasm --prefix=/Users/jkchen/Documents/svn/v2.0-b4/trunk/objs/ffmpeg.src/_release --cc= --enable-static --disable-shared --disable-debug --extra-cflags='-I${ffmpeg_exported_release_dir}/include' --extra-ldflags='-L${ffmpeg_exported_release_dir}/lib -lm -ldl' --extra-libs=-lrtmp --disable-ffserver --disable-doc --enable-postproc --enable-bzlib --enable-zlib --enable-parsers --enable-libx264 --enable-librtmp --enable-pthreads --extra-libs=-lpthread --enable-encoders --enable-decoders --enable-avfilter --enable-avresample --enable-muxers --enable-demuxers"
#define FFMPEG_LICENSE "nonfree and unredistributable"
#define CONFIG_THIS_YEAR 2015
#define FFMPEG_DATADIR "/Users/jkchen/Documents/svn/v2.0-b4/trunk/objs/ffmpeg.src/_release/share/ffmpeg"
#define AVCONV_DATADIR "/Users/jkchen/Documents/svn/v2.0-b4/trunk/objs/ffmpeg.src/_release/share/ffmpeg"
